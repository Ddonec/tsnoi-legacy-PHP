<?php
/*
Template Name: courses p one page
*/
?>
<?php
get_header();
...
<main>
  <section class="small-margin-section">
    <div class="first-block-blue-bg first-block-blue-bg-ways first-block-blue-bg-lvl-up">
      <img src="<?php echo bloginfo('template_url'); ?>/assets/content/p-one-img-asolute-1.png" class="fly-element p-one-img-1" />
      <img src="<?php echo bloginfo('template_url'); ?>/assets/content/p-one-img-asolute-2.png" class="fly-element p-one-img-2" />
      <div class="first-block-blue-bg-overflow ways-overflow">
        <img src="<?php the_field('p-one-main-human-image') ?>" class="ways-img-bg" />
