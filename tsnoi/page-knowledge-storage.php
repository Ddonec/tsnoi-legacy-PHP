...
<main>
      <section class="small-margin-section">
        <div class="first-block-blue-bg first-block-blue-bg-lvl-up">
          <img
            src="./assets/content/preschool-fly-1.png"
            class="fly-element preschool-img-1 knowlege-fly-no-hide"
          />

          <div class="first-block-blue-bg-overflow ways-overflow">
            <img
              src="./assets/content/fly-elem-2.png"
              class="fly-element preschool-img-2"
            />
            <img
              src="./assets/content/knowledge-absolut.png"
              class="ways-img-bg knowledge-absolut"
            />
        ...
        <div class="vebinar-cards-owerflow-container">
          <div class="vebinar-cards-container">
            <div class="vebinar-card">
              ...
              <img
                class="vebinar-card__absolute-img"
            ...
            <div class="vebinar-card">
              ...
              <img
                class="vebinar-card__absolute-img"
                src="./assets/content/vebinar-icon-2.png"
                alt=""
              />
            </div>
            <div class="vebinar-card">
              ...
              <img
                class="vebinar-card__absolute-img"
                src="./assets/content/vebinar-icon-3.png"
                alt=""
              />
            </div>
            <div class="vebinar-card">
              ...
              <div class="vebinar-card__vhite-btn vebinar-tab-131">Вебинар</div>
              <img
                class="vebinar-card__absolute-img vebinar-card__absolute-img-last"
                src="./assets/content/vebinar-icon-4.png"
                alt=""
              />
            </div>
          </div>
        ...
        <div class="last-vebinar-preview-box">
          <div class="last-vebinar-preview-card">
            ...
            <div class="last-vebinar-preview-card__btn-area">
              <div
                class="preview-card__btn-area_btn"
                onclick="activateModalAndBackground()"
              >
                Получить сертификат
              </div>
      ...
      <section class="youtube-section-knowledge">
        <div class="youtube-left">
          ...
          <a
            class="yiotube-link-btn"
            target="_blank"
            href="https://www.youtube.com/"
            >Перейти <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="youtube-right">
          <a href="https://www.youtube.com/">
            <img
              class="youtube-logo-absolute"
              src="./assets/content/youtube-logo.png"
              alt=""
            />
          </a>
        </div>
