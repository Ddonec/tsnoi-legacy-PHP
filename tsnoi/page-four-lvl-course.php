          ...
          <div class="first-block-blue-bg-overflow ways-overflow">
            ...
            <div class="blue-bg-courses-text-ways">
              <div class="blue-container-flex-tabs">
                <div class="blue-bg-courses__button">ПП - 101</div>
                <div class="blue-bg-courses__whitebutton">Новинка</div>
              </div>
              <h1 class="h1-text four-blue-title">
                Музыкальное воспитание в&nbsp;дошкольной образовательной
                организации и начальной школе
              </h1>
              <p class="h1-subtext ways-first-discription">
                С присвоением квалификации «Музыкальный руководитель дошкольной
                образовательной организации», «Учитель музыки»
              </p>
              <div class="blue-cont-four-btns-box">
                <div class="blue-cont-four-btns-box__sign-up">Записаться</div>
      ...
      <section class="second-section-four-lvl">
        <div class="white-blocks-container">
          <div class="white-block">
            <h4 class="white-block__title">560</h4>
            <p class="white-block__subtitle">академических часов</p>
          </div>
          <div class="white-block">
          ...
          <div class="white-block">
            <h4 class="white-block__title">Online</h4>
            <p class="white-block__subtitle">
              Заочная форма обучения (дистанционно)
            </p>
          </div>
          <div class="white-block">
            <h4 class="white-block__title">Старт</h4>
            <p class="white-block__subtitle">1 и 15 числа каждого месяца</p>
          </div>
        </div>
        <div class="programm-info-block">
          <div class="programm-info__left">
            ...
            <a class="programm-info__link" href="#"
              ><div class="programm-info__btn">Читать полностью</div></a
            >
          </div>
