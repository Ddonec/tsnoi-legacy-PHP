      ...
      <section class="small-margin-section">
        <div class="first-block-blue-bg first-block-blue-bg-lvl-up">
          <img
            ...
            class="fly-element preschool-img-1"
          />

          <div class="first-block-blue-bg-overflow ways-overflow">
            <img
              src="./assets/content/preschool-fly-2.png"
              class="fly-element preschool-img-2"
            />
            <img
              src="./assets/content/preschool-bg-absolute.png"
              class="ways-img-bg preschool-absolute-man"
            />
            <div class="blue-bg-courses-text-ways">
              <div class="blue-bg-courses__button">
                Курсы профессиональной переподготовки
              </div>
              <h1 class="h1-text">Дошкольное образование</h1>
